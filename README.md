...
> **Note:** It was developed for the "Classification of bacteria by combination scattering spectra" project within the Scientific and Technical Conference of RTU MIREA, section "Applied Physics", May 2025. The project achieved an accuracy of 83% in separating two classes of bacteria and received 3rd place prize at the Conference for its unique approach to applied field.
